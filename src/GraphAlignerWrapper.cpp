...
{
	GraphAlignerCommon<size_t, int64_t, uint32_t>::Params params {alignmentBandwidth, graph, std::numeric_limits<size_t>::max(), quietMode, preciseClippingIdentityCutoff, Xdropcutoff, 0, clipAmbiguousEnds, std::numeric_limits<size_t>::max()};
	GraphAligner<size_t, int64_t, uint32_t> aligner {params};
...
{
	GraphAlignerCommon<size_t, int64_t, uint32_t>::Params params {alignmentBandwidth, graph, maxCellsPerSlice, quietMode, preciseClippingIdentityCutoff, Xdropcutoff, multimapScoreFraction, clipAmbiguousEnds, maxTraceCount};
	GraphAligner<size_t, int64_t, uint32_t> aligner {params};
...
{
	GraphAlignerCommon<size_t, int64_t, uint32_t>::Params params {1, AlignmentGraph::DummyGraph(), 1, true, .5, 0, 0, 0, 0};
	GraphAligner<size_t, int64_t, uint32_t> aligner {params};
...
{
	GraphAlignerCommon<size_t, int64_t, uint32_t>::Params params {1, graph, 1, true, .5, 0, 0, 0, 0};
	GraphAligner<size_t, int64_t, uint32_t> aligner {params};
