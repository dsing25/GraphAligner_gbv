...
namespace AlignmentSelection
{
	...
	std::tuple<size_t, size_t, std::vector<int>> getAlignmentPath(const AlignmentGraph& graph, const std::vector<GraphAlignerCommon<size_t, int64_t, uint32_t>::TraceItem>& trace)
	{
		size_t leftClip = 0;
		size_t rightClip = 0;
